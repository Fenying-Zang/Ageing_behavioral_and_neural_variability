...
STEPS = [
    ...
    # "scripts.preprocessing_01_generate_merged_tables",  # NOTE: Merge trials tables — optional; skip to use pre-merged tables and save time
    ...
    # "scripts.neural_03b_stats_BFs",                      # Bayesian Factors -- NOTE: without R, let's skip it here
